...
# What is Docker?
Docker is an application that can significantly reduce the time, effort and cost of deploying software.  In fact, reduces the time needed to install and configure an application by at least an order of magnitude:  From hours down to minutes or even seconds.
